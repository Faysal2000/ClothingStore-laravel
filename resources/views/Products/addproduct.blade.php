...
@section('content')
    ...
    @else
        <!-- عرض رسالة تسجيل الدخول أو التسجيل إذا لم يكن المستخدم مسجل دخول -->
        <div style="text-align: center; margin-top: 20px;">
            <p>يرجى <a href="{{ route('login') }}">تسجيل الدخول</a> أو <a href="{{ route('register') }}">إنشاء حساب
                    جديد</a> لإضافة منتج.</p>
        </div>
    @endif
